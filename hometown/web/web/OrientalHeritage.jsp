    ...
    <div class="container">
        <div class="row text-center">
            <%
                try {
                    ...
                    // 创建 SQL 语句
                    String sql = "SELECT name,description,image FROM attraction LIMIT 9 OFFSET 12";
        ...
        <div class="row" data-scroll-index="6">
            <%
                try {
                    ...
                    // 创建 SQL 语句
                    String sql = "SELECT name,description,image FROM fangte";
        ...
        <aside class="video-block" data-scroll-index="3">
            <video autoplay="autoplay" loop="loop" id="video" x-webkit-airplay="true" webkit-playsinline="true" muted=""width=1000px>
                <source src="../img/【P1】方特万圣节限定烟花秀太美了一定要带你最爱的一起来看！.flv" type="video/mp4">
            </video>
        </aside>
    </div>
</main>
