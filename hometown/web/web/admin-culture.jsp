        ...
        <div class="">
          ...
          <div style="float: left;width: 1000px">
            <form action="search.jsp" method="post">
              <div class="col-xs-7">
                <input class="form-control" name="searchCulture" type="text" placeholder="请输入你要搜索的内容">
              </div>
          ...
          <%
            // 处理查询结果集
            out.print("<form action='admin-culture-update.jsp' method='post'><table class='table table-hover'><tr><th>id</th><th>name</th><th>description</th><th>image</th><th>创建时间</th><th>更新时间</th><th>修改</th></tr>");
