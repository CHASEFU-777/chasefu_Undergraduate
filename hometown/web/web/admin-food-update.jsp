                ...
                <div class="">
                    <%
                        ...
                        if (tom != null) {
                            try {
                                ...
                                String foodid = request.getParameter("tom");
                                // 处理查询结果集
                                out.print("<form action='update.jsp' method='post'><table class='table table-hover'><tr><th>id</th><th>name</th><th>description</th><th>rating</th><th>image</th></tr>");
                                while (rs.next()) {
                                    if (rs.getString("id").equals(foodid)) {
                                        int id = rs.getInt("id");
                                        ...
                                        out.print("</tr>");
                                        out.print(" <td><button class='btn btn-w-md btn-round btn-danger' name='fooddelete' value='" + foodid + "'>删除</button></td>");
                                        out.print(" <td><button class='btn btn-w-md btn-round btn-primary' name='foodupdate' value='" + foodid + "'>修改</button></td>");
                                    }
                                }
                    ...
                    <%
                        ...
                        if (add != null) {
                            ...
                            out.print("<label for='评分'>评分:</label>");
                            out.print("<textarea type='rating' id='rating' name='rating'></textarea><br><br>");
