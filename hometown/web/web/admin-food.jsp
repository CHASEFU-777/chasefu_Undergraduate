      ...
      <div class="container">
        <div class="">
          ...
          <div style="float: right;width: 100px;margin-right: 10px">
            <form action='admin-food-update.jsp' method='post'>
          ...
          <%
            // 处理查询结果集
            out.print("<form action='admin-food-update.jsp' method='post'><table class='table table-hover'><tr><th>id</th><th>name</th><th>description</th><th>image</th><th>评分</th><th>创建时间</th><th>更新时间</th><th>修改</th></tr>");
            while (rs.next()) {
              int id = rs.getInt("id");
