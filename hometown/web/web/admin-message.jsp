                ...
                <div class="">
                    ...
                    <div style="float: left;width: 1000px">
                        <form action="search.jsp" method="post">
                            <div class="col-xs-7">
                                <input class="form-control" name="searchFood" type="text" placeholder="请输入你要搜索的内容">
                            </div>
                    ...
                    <%
                        // 处理查询结果集
                        out.print("<form action='update.jsp' method='post'><table class='table table-hover'><tr><th>id</th><th>用户名</th><th>邮箱</th><th>留言内容</th><th>创建时间</th><th>删除</th></tr>");
                        ...
                        while (rs.next()) {
                            ...
                            out.print("<td><button class='btn btn-w-md btn-round btn-danger' name='mesdelete' value='"+id+"'>"+"删除"+"</button></td>");
                            out.print("</tr>");
                        }
