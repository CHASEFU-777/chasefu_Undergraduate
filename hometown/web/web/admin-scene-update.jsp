                    ...
                    <%
                        ...
                        if (tom != null) {
                            try {
                                ...
                                // 处理查询结果集
                                out.print("<form action='update.jsp' method='post'><table class='table table-hover'><tr><th>景点ID</th><th>名称</th><th>描述</th><th>图片</th><th>地址</th><th>创建时间</th><th>更新时间</th></tr>");
                                while (rs.next()) {
                                    if (rs.getString("id").equals(userid)) {
                                        ...
                                        out.print("</tr>");
                                        out.print(" <td><button class='btn btn-w-md btn-round btn-danger' name='scdelete' value='" + userid + "'>删除</button></td>");
                                        out.print(" <td><button class='btn btn-w-md btn-round btn-primary' name='scupdate' value='" + userid + "'>修改</button></td>");
                                    }
                                }
                        ...
                        try {
                            ...
                            // 插入新用户信息
                            String sql = "INSERT INTO attraction (name, description, image,address) VALUES (?, ?, ?,?)";
