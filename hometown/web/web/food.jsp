...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="before/food.css">
</head>
<body>
<header id="header">
  <div class="container">
      ...
      <nav class="navbar navbar-default">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="food.jsp" style="color:#ffe047;">甬城美食</a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-md-7">
        <img src="img/八珍.png" height="90px" style="padding-top: 1px;">
      </div>
    </div>
  </div>
</aside>
...
<%
  try {
    ...
    // 创建 SQL 语句
    String sql = "SELECT name,description,rating FROM food";
...
<div class="video overlay">
  <img src="img/宴.png" alt="image description" class="img-responsive">
</div>
<!-- Footer of the page -->
<footer id="footer">
  <!-- Aside of the page -->
